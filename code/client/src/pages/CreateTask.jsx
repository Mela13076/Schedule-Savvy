...
function CreateTask({ api_url, categories }) {
  ...
  const createTask = async (event) => {
    ...
    const addTask = async () =>{
      ...
      setTask(data); // Update the task state with the data received from the API
      return data.task_id;

    }

    // const addCategoryOf = async (task_id) => {
    ...
    const addCategoryOf = async (task_id) => {
      for (const categoryOption of selectedCategories) {
        ...
        const categoryOf = {
          task_id: task_id, // Use the newly created task_id
